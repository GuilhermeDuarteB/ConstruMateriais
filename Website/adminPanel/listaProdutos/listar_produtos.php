...
<body>
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="title-section">
                    ...
                    <div class="mostrar-inativos">
                        <label class="checkbox-label">
                            <input type="checkbox" id="mostrarInativos" <?php echo $mostrar_inativos ? 'checked' : ''; ?>>
                            <span class="checkbox-text">Mostrar Inativos</span>
                        </label>
                    </div>
                </div>
                <a href="../produtos/produtos.php" class="btn-add">
    ...
    document.getElementById('mostrarInativos').addEventListener('change', function() {
        ...
        if (this.checked) {
            currentUrl.searchParams.set('mostrar_inativos', '1');
        } else {
            currentUrl.searchParams.delete('mostrar_inativos');
        }
